  ...
  return (
    <aside className="sidebar-monarch p-4 flex flex-col justify-between">
      ...
      <div className="px-2 py-3 border-t border-gray-200 mt-2">
        <div className="text-[10px] uppercase font-bold text-gray-400 mb-2 px-2">Other Products</div>
        <Link
          href="/magnifi"
          className="flex items-center gap-3 p-2 rounded-lg text-secondary hover:bg-gray-100 transition-colors"
        >
          <span aria-hidden="true" className="w-5 h-5 rounded flex items-center justify-center text-xs font-bold" style={{ background: '#E0CD72', color: '#030F12' }}>M</span>
          <span className="font-medium">Magnifi</span>
